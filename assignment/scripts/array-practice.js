...
let foodArray = ['tacos', 'pizza', 'burgers', 'steak'];
...
console.log('The last animal in the array is', animalArray.indexOf('dog'));

// 3.c. (STRETCH) TODO: Log the last animal by using the array length,
//      instead of the exact index number of the last item
console.log('The last animal in the array is', animalArray.length - 1);
